...
namespace Infrastructure.Persistence.Configurations
{
    public class DeliveryRequestConfiguration : IEntityTypeConfiguration<DeliveryRequest>
    {
        public void Configure(EntityTypeBuilder<DeliveryRequest> builder)
        {
            ...
            builder.Property(x => x.CancelRequestedAt).IsRequired(false);
            builder.Property(x => x.CancelDecisionAt).IsRequired(false);
            builder.Property(x => x.CancelApproved).IsRequired(false);
            builder.Property(x => x.CancelPreviousStatus).IsRequired(false);
